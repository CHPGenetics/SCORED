...
This repository accompanies the manuscript “Resolving isoform dynamics with a combined timesnapshot DOGMA-seq and refined long-read framework,” providing all associated data processing and analytical workflows. The fully reproducible results notebook is available [here](https://cdn.statically.io/gh/CHPGenetics/SCORED/main/experiments/paper_results.html).
