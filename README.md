...
This repository accompanies the manuscript “Resolving isoform dynamics with a combined timesnapshot DOGMA-seq and refined long-read pipeline,” providing all associated data processing and analytical workflows. The fully reproducible results notebook is available [here](https://raw.githack.com/CHPGenetics/SCORED/main/experiments/SCORED_paper_results.html).
...
# Data is normalized. Use log transformation to adjust the scale if needed for your analysis.
```
